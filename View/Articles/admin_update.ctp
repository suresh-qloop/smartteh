...
$this->set('title_for_layout', $page_title = __d('admin', 'Article').' » '.__d('admin', 'edit'));
...
<?= $this->Form->create('Article', ['url' => ['controller' => 'articles', 'action' => 'update'], 'type' => 'file']) ?>
...
<?= $this->element('admin/upload-element', [
	...
	'preview_dir' => '../uploads/images/articles/thumb/',
	'field' => 'filename',
	'model' => 'Article'
]) ?>
